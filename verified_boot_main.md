...
- [1. Introduction](#1-introduction)
  * [Trust, chain of trust, root of trust](#trust-chain-of-trust-root-of-trust)
    + [Trust](#trust)
    + [Root of Trust (RoT)](#root-of-trust-rot)
    + [Chain of Trust (CoT)](#chain-of-trust-cot)
    + [Trusted Computing Base (TCB)](#trusted-computing-base-tcb)
  * [Categorization of chains/roots of trust](#categorization-of-chainsroots-of-trust)
    + [RTM (Root of Trust for Measurements)](#rtm-root-of-trust-for-measurements)
      - [S-RTM (Static Root of Trust for Measurements)](#s-rtm-static-root-of-trust-for-measurements)
      - [D-RTM (Dynamic Root of Trust for Measurements)](#d-rtm-dynamic-root-of-trust-for-measurements)
    + [RTR (Root of Trust for Reporting)](#rtr-root-of-trust-for-reporting)
    + [RTS (Root of Trust for Storage)](#rts-root-of-trust-for-storage)
    + [RTV (Root of Trust for Verification)](#rtv-root-of-trust-for-verification)
  * [The difference between verified boot and measured boot](#the-difference-between-verified-boot-and-measured-boot)
    + [Verified Boot](#verified-boot)
    + [Measured Boot](#measured-boot)
    + [Comparison of verified boot and measured boot](#comparison-of-verified-boot-and-measured-boot)
    + [Cross-references](#cross-references)
  * [Difference between integrity and authenticity verification](#difference-between-integrity-and-authenticity-verification)
    + [Integrity Verification](#integrity-verification)
    + [Authenticity](#authenticity)
      - [Non repudiation](#non-repudiation)
- [2. Definition of requirements](#2-definition-of-requirements)
  * [Threat model](#threat-model)
  * [Functional requirements](#functional-requirements)
  * [Non-functional requirements](#non-functional-requirements)
- [3. Firmware](#3-firmware)
  * [Implementations of verified boot](#implementations-of-verified-boot)
    + [Legacy](#legacy)
    + [UEFI](#uefi)
    + [Heads](#heads)
  * [Firmware protections against changing settings in its UI](#firmware-protections-against-changing-settings-in-its-ui)
  * [Firmware protections against changing firmware's flash chip](#firmware-protections-against-changing-firmwares-flash-chip)
  * [Intel Boot Guard / AMD Platform Secure Boot](#intel-boot-guard--amd-platform-secure-boot)
    + [Intel Boot Guard](#intel-boot-guard)
    + [AMD Platform Secure Boot](#amd-platform-secure-boot)
- [4. OS-level approaches at limiting system modification](#4-os-level-approaches-at-limiting-system-modification)
  * [Role-based boot modes](#role-based-boot-modes)
  * [Read-only](#read-only)
    + [Read-only physical media](#read-only-physical-media)
    + [Read-only filesystems](#read-only-filesystems)
    + [Mounting as read-only on Linux](#mounting-as-read-only-on-linux)
    + [Read-only filesystem permission](#read-only-filesystem-permission)
    + [Immutable storage concept](#immutable-storage-concept)
    + [Immutable Linux OS](#immutable-linux-os)
    + [Immutable vs stateless](#immutable-vs-stateless)
  * [Checksum verification](#checksum-verification)
    + [Checksums and hash codes](#checksums-and-hash-codes)
    + [Common hashing algorithms](#common-hashing-algorithms)
    + [Hash verification in chain of trust context](#hash-verification-in-chain-of-trust-context)
    + [Extending chain of trust to OS](#extending-chain-of-trust-to-os)
  * [dm-verity](#dm-verity)
  * [LUKS drive encryption](#luks-drive-encryption)
    + [Integrity protection with dm-integrity](#integrity-protection-with-dm-integrity)
    + [TPM support](#tpm-support)
  * [CVMs](#cvms)
    + [References](#references)
  * [ISOs](#isos)
    + [Verifying boot media with secure-boot](#verifying-boot-media-with-secure-boot)
    + [Modifying ISOs with growisofs](#modifying-isos-with-growisofs)
